...
import img from "../assets/logImg.svg";
          ...
          <div class="border border-gray-300 rounded-lg p-6 max-w-md shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] max-md:mx-auto">
            <form class="space-y-4">
              ...
              <div class="flex flex-wrap items-center justify-between gap-4">
                ...
                <div class="text-sm">
                  <a href="jajvascript:void(0);" class="text-violet-600 hover:underline font-semibold">
              ...
              <p class="text-sm !mt-8 text-center text-gray-800">Don't have an account <a href="javascript:void(0);" class="text-violet-600 font-semibold hover:underline ml-1 whitespace-nowrap">Register here</a></p>
            </form>
          </div>
